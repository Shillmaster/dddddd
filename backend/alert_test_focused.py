...
class AlertAPITester:
    def __init__(self, base_url: str = "https://adaptive-fractal.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://adaptive-fractal.preview.emergentagent.com")
