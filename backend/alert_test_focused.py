...
class AlertAPITester:
    def __init__(self, base_url: str = "https://tradeanalyzer-8.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://tradeanalyzer-8.preview.emergentagent.com")
